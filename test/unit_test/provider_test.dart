...
void main() {
  group("MovieApiProvider test", () {
    test("fetchMovieList success test", () async {
      ...
      when(mockClient.get(
              "http://api.themoviedb.org/3/movie/popular?api_key=b7787a762b4e9657fe3b3f84874e07ba"))
    ...
    test("fetchTrailer success test", () async {
      ...
      var mockClient = app.mockClient;
      when(mockClient.get(
              "http://api.themoviedb.org/3/movie/420818/videos?api_key=b7787a762b4e9657fe3b3f84874e07ba"))
          .thenAnswer((_) async => http.Response(
    ...
    test("fetchTrailer fail test", () async {
      ...
      var mockClient = app.mockClient;
      when(mockClient.get(
              "http://api.themoviedb.org/3/movie/428/videos?api_key=b7787a762b4e9657fe3b3f84874e07ba"))
          .thenAnswer((_) async => http.Response(
